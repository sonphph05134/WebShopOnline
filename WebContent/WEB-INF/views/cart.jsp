...
<div class="row">
	...
	<div class="span9">
		...
		<h3>
			Giỏ hàng [ <small>${cartlist.size() } Sản phẩm </small>]<a href="products.html"
		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					<td colspan="5" style="text-align: right"><strong>Tổng tiền
							=</strong></td>
		...
		<a href="products.html" class="btn btn-large"><i
			class="icon-arrow-left"></i> Trở lại mua sắm </a> <a href="payment.html"
